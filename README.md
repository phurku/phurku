...
Azure Virtual Machines, Azure Networking Basics, MFA & Conditional Access

## Development Background 
Flutter (Dart), Java, HTML, CSS, JavaScript, REST APIs
Git & GitHub

## 📂 Featured Projects
🔹 Cloud Migration Demo
A simulated migration of on‑prem resources to Azure, focusing on identity, access, and resource organisation.
(Add link when uploaded)

🔹 IT Support Ticketing System
A simple ticketing system built with React + Node.js to track and resolve IT issues.
(Add link when uploaded)
...
![](https://github-readme-streak-stats.herokuapp.com/?user=phurku&theme=tokyonight&hide_border=false)  
...
![](https://github-contributor-stats.vercel.app/api?username=phurku&limit=5&theme=algolia&combine_all_yearly_contributions=true&timestamp=1)
